/**************************************************************************************************
  Filename:       NLMEDE.h
  Revised:        $Date: 2010-05-08 17:49:17 -0700 (Sat, 08 May 2010) $
  Revision:       $Revision: 22425 $
...
enum  bcast_addr_e {
  ...
  NWK_BROADCAST_SHORTADDR_AABB     = 0x0000
 ...
 *
 */
extern ZStatus_t NLME_JoinRequest( uint8 *extendedPANID, uint16 PanId, byte Channel, byte CapabilityFlags);
