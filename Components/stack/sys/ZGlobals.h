...
#define ZDO_COORDINATOR 1
#endif
#endif
#if defined( ZigBee_C_R_E_Engineering )
#define ZigBee_C_R_E_Transparent   //网路广播模式，宏定义
#define ZigBee_C_R_E_PANID   //网络PANID +1后重启恢复选项
#endif
//#define DEFAULT_CHANLIST  ((uint32)0X00000001<<CHANLIST_C_R_E) //CHANLIST_C_R_E   11-26
  extern void CRCRC(void);
...
#if defined (SENSOR_TYPE_Coord) 
extern uint16  ZG_BUILD_COORDINATOR_TYPE;
extern uint16  ZG_BUILD_RTR_TYPE;
extern uint16  ZG_BUILD_ENDDEVICE_TYPE;
extern uint16  ZG_BUILD_RTRONLY_TYPE;
extern uint16  ZG_BUILD_JOINING_TYPE;

extern uint16 DEVICE_LOGICAL_TYPE;
extern uint16 ZSTACK_DEVICE_BUILD;
extern uint16 ZG_DEVICE_COORDINATOR_TYPE;
extern uint16 ZG_DEVICE_RTR_TYPE;
extern uint16 ZG_DEVICE_JOINING_TYPE;
