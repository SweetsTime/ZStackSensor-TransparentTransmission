...
// 0x0401 ?0x0FFF
#define ZCD_NV_APP_PANID_H      0x0401     //PANID_H
#define ZCD_NV_APP_PANID_L      0x0403      //PANID_L
#define ZCD_NV_APP_NLME_GetShortAddr_H      0x0405     //NLME_GetShortAddr_H
#define ZCD_NV_APP_NLME_GetShortAddr_L      0x0407      //NLME_GetShortAddr_L
#define ZCD_NV_APP_C_R                      0x0409      //C_R 
#define ZCD_NV_APP_R_E_KEY_P07              0x040B      //ZCD_NV_APP_R_E_KEY_P07
#define ZCD_NV_APP_C_R_C                    0x040D      //同级路由标记
#define ZCD_NV_APP_CHANLIST                 0x040F      //同级路由标记
#define ZCD_NV_APP_AD_SHINING               0x0411      //电子秤误差系数
