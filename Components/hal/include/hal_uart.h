...
#define HAL_UART_BR_600 0x10
#define HAL_UART_BR_1200 0x11
#define HAL_UART_BR_2400 0x12
#define HAL_UART_BR_4800 0x13
...
extern uint16 HalUARTCLER(uint8 port,uint16 len);
/*
