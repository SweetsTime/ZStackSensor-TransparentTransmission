/**************************************************************************************************
  Filename:       OnBoard.h
  Revised:        $Date: 2010-05-28 15:00:11 -0700 (Fri, 28 May 2010) $
  Revision:       $Revision: 22675 $
...
#define SW_BYPASS_NV    0x0f//HAL_KEY_SW_1  // Bypass Network layer NV restore
#define SW_BYPASS_START 0x0f//HAL_KEY_SW_2  // Bypass Network initialization
#else
...
#ifdef SERIAL_SUPPORTED
  #if SERIAL_SUPPORTED==DEBUG
